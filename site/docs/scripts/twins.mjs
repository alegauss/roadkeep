...
const BUILT = join(HERE, "..", "..", "dist", "docs");
const LLMS = join(HERE, "..", "..", "public", "llms.txt");
...
const base = "https://alegauss.github.io/roadkeep/docs";
const index = [
...
if (!llms.includes("docs/llms.txt")) {
  throw new Error(
    "[twins] site/public/llms.txt does not name docs/llms.txt — an agent starting at the site " +
      "root would never find these pages",
  );
}
