...
BACKSTOP: tuple[Backstopped, ...] = (
    *_same(
    ...
    # RK1690, closed by RK1693: refused where `validate` composes the line, and reported under
    # the same names where a hand wrote one — the gate reads the writer's own recogniser.
    *_same("validation.verdict", "validation.saw"),
)
...
#: one somebody has to notice writing a refusal without a backstop. RK1690's two were those,
#: noticed and filed, and RK1693 gave the gate the verdict reader that emptied it again.
