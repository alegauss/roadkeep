...
| --- | --- | --- | --- |
| A — The model (a task is data before it is a line) | 1 | 27 | 1 |
| B — Authoring (insert, never hand-edit) | 1 | 56 | 0 |
| C — Query (consult without reading the file) | 1 | 37 | 0 |
| D — The gate | 1 | 50 | 0 |
| E — Adoption | 0 | 30 | 1 |
| F — The Claude Code plugin (the guardrail at the agent boundary) | 2 | 32 | 1 |
| **Total** | 6 | 232 | 3 |
