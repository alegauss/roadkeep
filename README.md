...
- ⏳ **RK1498** (deps: RK1532 ✅) **thirty of the thirty-six sites that compose a door are accounted for as a work-list, so nothing ever runs one** — Ten of the sites are still accounted for as a work-list rather than run, one fixture family at a time. → §RK1498
<!-- roadkeep:end -->
