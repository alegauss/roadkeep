...
| B — Authoring (insert, never hand-edit) | 7 | 69 | 0 |
| C — Query (consult without reading the file) | 3 | 47 | 0 |
| D — The gate | 5 | 57 | 0 |
| E — Adoption | 2 | 50 | 1 |
| F — The Claude Code plugin (the guardrail at the agent boundary) | 0 | 64 | 1 |
| **Total** | 18 | 315 | 3 |
