...
| B — Authoring (insert, never hand-edit) | 3 | 56 | 0 |
| C — Query (consult without reading the file) | 3 | 37 | 0 |
| D — The gate | 1 | 50 | 0 |
| E — Adoption | 1 | 30 | 1 |
| F — The Claude Code plugin (the guardrail at the agent boundary) | 1 | 45 | 1 |
| **Total** | 9 | 246 | 3 |
