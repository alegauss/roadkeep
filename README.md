...
| B — Authoring (insert, never hand-edit) | 2 | 220 | 2 |
| C — Query (consult without reading the file) | 2 | 144 | 2 |
| D — The gate | 1 | 207 | 2 |
| E — Adoption | 0 | 117 | 1 |
| F — The Claude Code plugin (the guardrail at the agent boundary) | 2 | 134 | 2 |
