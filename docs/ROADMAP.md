...
- 💭 **RK1557** (deps: —) **the gate against a composed marker reads a bare name, so the same constant reached through its module walks past** — RK1520 closed one spelling of the repair its predecessor rewarded and left the other, which is the shape of the defect it was written for. → §RK1557
