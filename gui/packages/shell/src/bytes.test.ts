 ...
 *
 * `../.github` is the tree gui/ lives in (RK1697): its workflows moved to the root, where GitHub
 * reads them, and are this app's as much as they were under `.github` here.
 */
